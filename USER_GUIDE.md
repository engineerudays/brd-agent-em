...
5. [Processing BRDs](#processing-brd)
...
1. **Backend Services Running**:
   ...
   ```
   This starts:
   - n8n (workflow orchestrator) on port `5678`
   - BRD Parser (PDF/text extraction) on port `8000`

2. **All Workflows Activated in n8n**:
   - Master Orchestrator
   - Engineering Plan Generator
   - Project Schedule Generator
   - BRD Input Cleaner

3. **Streamlit UI Running**:
   ```bash
   cd frontend
...
The Engineering Plan includes **8 collapsible sections**:
...
**Filename Format**:
```
engineering_plan_2025-11-22.json
project_schedule_2025-11-22.json
```
...
2. Go to "Master Orchestrator" workflow
...
2. Re-import Master Orchestrator workflow in n8n
3. Process a fresh BRD
...
4. **Troubleshooting**:
   - Always check Docker containers first
...
- **Workflow Guide**: `n8n_flows/planning_agent/WORKFLOW_GUIDE.md`

### Testing

- **Integration Tests**: `tests/integration/`
- **Sample BRDs**: `sample_inputs/brds/`
- **Test Scripts**: `tests/integration/*.sh`
